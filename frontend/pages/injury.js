		...
		<>
			...
			<div className={styles.main}>
				<div className={styles.sec1}>
					<svg version='1.1' id='Icons' xmlns='http://www.w3.org/2000/svg' xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 87.2 71.2' enableBackground='new 0 0 87.2 71.2' space='preserve' fill='#002d62' width='12rem'>
						<g>
							<path
								fill='#002d62'
			...
			C74.3,45,74.5,42.6,73.3,41.7z'
							/>
							<path fill='#002d62' d='M64.4,66.3c2.5-2.6,0.8-4.4,0.8-4.4l-10-14.1l-7.6,5.8l12.5,13.4C60.1,67.1,62.2,68.6,64.4,66.3z' />
							<path
								fill='#002d62'
			...
			C76.4,36.2,74.8,35.5,73.1,35.5z'
				...
				<div className={styles.dropdowns}>
					...
					<div className={styles.spacer}>
						<div className={styles.attorneybar} onClick={() => displayDropdown(2)}>
							<svg version='1.1' id='Layer_1' xmlns='http://www.w3.org/2000/svg' xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 164 133' enableBackground='new 0 0 164 133' space='preserve' fill='#fff' width={50}>
								<path
									stroke='#FFFFFF'
									strokeWidth='0.4613'
                      ...
                      C47.6,70,34.1,70,20.3,70z M131.1,34.7L149.4,70c-13.6,0-27,0-40.8,0L131.1,34.7z'
							...
							<div style={{ marginLeft: '0.8rem' }}>
								<p>Motor Vehicle/Truck Accidents</p>
							</div>
					...
					{showDropdown == 2 && (
						<div className={styles.dropBody}>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
							<div className={styles.bodyImg} style={{ backgroundImage: "url('/medical_leave.jpg')" }}></div>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
						</div>
					)}
					...
					<div className={styles.spacer}>
						<div className={styles.attorneybar} onClick={() => displayDropdown(3)}>
							<svg version='1.1' id='Layer_1' xmlns='http://www.w3.org/2000/svg' xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 164 133' enableBackground='new 0 0 164 133' space='preserve' fill='#fff' width={50}>
								<path
									stroke='#FFFFFF'
									strokeWidth='0.4613'
                      ...
                      C47.6,70,34.1,70,20.3,70z M131.1,34.7L149.4,70c-13.6,0-27,0-40.8,0L131.1,34.7z'
							...
							{showDropdown == 3 ? <p className={styles.dropStatus}>CLOSE</p> : <p className={styles.dropStatus}>OPEN</p>}
						</div>
					</div>
					{showDropdown == 3 && (
						<div className={styles.dropBody}>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
							<div className={styles.bodyImg} style={{ backgroundImage: "url('/sexual_harassment.jpg')" }}></div>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
						</div>
					)}
