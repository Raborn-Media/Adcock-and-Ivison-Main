...
const HomeHead = () => {
  ...
  const [medicalheader, setmedicalheader] = useState(null);
  const [loadmedicalheader, setloadmedicalheader] = useState(true);
  useEffect(() => {
    fetch(`${URL}/medical-header`)
      .then((res) => res.json())
      .then((medicalheader) => {
        setmedicalheader(medicalheader);
        setloadmedicalheader(false);
      });
  }, []);
  ...
  const [insuranceheader, setinsuranceheader] = useState(null);
  const [loadinsuranceheader, setloadinsuranceheader] = useState(true);
  useEffect(() => {
    fetch(`${URL}/insurance-header`)
      .then((res) => res.json())
      .then((insuranceheader) => {
        setinsuranceheader(insuranceheader);
        setloadinsuranceheader(false);
      });
  }, []);
  ...
  if (loadclaimheader || loadbusinessheader || loadinjuryheader || loadinsuranceheader || loadmedicalheader) {
  ...
  return (
		<>
          ...
          height: 82vh;
			...
			<div className='slider'>
				<div style={{ backgroundImage: "url('/employment_claims.jpg')" }} className={content === 1 ? ' slide' + ' ' + styles.back : ' slide2' + ' ' + styles.back}>
	...
	c0-2.1-1.1-3.8-2.4-3.8C52.7,24.3,51.8,25.6,51.8,27.3z'
				...
				<div
					...
					className={content === 2 ? ' slide' + ' ' + styles.back : ' slide2' + ' ' + styles.back}>
					<div className={styles.textAnim}>
						<div>
							<h1
								dangerouslySetInnerHTML={{
	...
	c0-2.1-1.1-3.8-2.4-3.8C52.7,24.3,51.8,25.6,51.8,27.3z'
				...
				<div
					style={{
						backgroundImage: "url('/medical_header.jpg')",
						backgroundPosition: 'center top 50%',
						backgroundSize: '100%',
					}}
					className={content === 3 ? ' slide' + ' ' + styles.back : ' slide2' + ' ' + styles.back}>
					<div className={styles.textAnim}>
						<div>
							<h1
								dangerouslySetInnerHTML={{
									__html: medicalheader.data.attributes.largeText,
								}}></h1>
							<p
								dangerouslySetInnerHTML={{
	...
	c0-2.1-1.1-3.8-2.4-3.8C52.7,24.3,51.8,25.6,51.8,27.3z'
				...
				<div
					style={{
						backgroundImage: "url('/business_header.jpg')",
						backgroundPosition: 'center top 50%',
						backgroundSize: '100%',
					}}
					className={content === 4 ? ' slide' + ' ' + styles.back : ' slide2' + ' ' + styles.back}>
					<div className={styles.textAnim}>
						<div>
							<h1
								dangerouslySetInnerHTML={{
	...
	c0-2.1-1.1-3.8-2.4-3.8C52.7,24.3,51.8,25.6,51.8,27.3z'
				...
				<div
					style={{
						backgroundImage: "url('/insurance_header.jpg')",
						backgroundPosition: 'center top 50%',
						backgroundSize: '100%',
					}}
					className={content === 5 ? ' slide' + ' ' + styles.back : ' slide2' + ' ' + styles.back}>
					<div className={styles.textAnim}>
						<div>
							<h1
								dangerouslySetInnerHTML={{
									__html: insuranceheader.data.attributes.largeText,
								}}></h1>
							<p
								dangerouslySetInnerHTML={{
