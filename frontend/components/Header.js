				...
				<div className={styles.topright}>
					...
					<div className={styles.toprightinfo}>
						<div className={styles.toprightsvg}>
							<svg version='1.1' id='Isolation_Mode' xmlns='http://www.w3.org/2000/svg' xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 102.7 102.9' enableBackground='new 0 0 102.7 102.9' space='preserve' fill='#fff' width={28} height={28}>
								<g>
									<path
